...
const Service: React.FC = () => {
  const services = [
    ...
    { icon: faLocationArrow, color: 'text-indigo-500', title: 'GPS Tracking', description: 'Real-time GPS tracking and live updates for all services, ensuring safety and transparency.' },
  ];
  ...
  const features = [
    ...
    { icon: faLocationArrow, color: 'text-green-600 animate-bounce', title: 'Live Tracking', description: 'Monitor your ride or shipment in real-time.' },
